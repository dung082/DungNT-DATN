...
export default function ChiTietDonXinNghi(props) {
        ...
        <div className="py-3">
            ...
            <div className="mt-5 text-center">
                ...
                <Popconfirm
                    ...
                    description="Bạn có chắc chắn duyệt đơn xin nghỉ?"
                    onConfirm={() => {
                        dispatch(duyetDonXinNghiAction(props?.DiemDanh?.id))
                    }}
                    //   onCancel={cancel}
                    okText="Duyệt"
                    cancelText="Hủy"
